    ...
    <div>
      <div>
        <p className="text-4xl font-semibold">
          {t('navigator.contact_us_p1')} <span className="text-baseColor">{t('navigator.contact_us_p2')}</span>
        </p>
      </div>
      <div className="grid gap-8 grid-cols-2">
        ...
        <div className="">
          ...
          <p className='text-5xl font-semibold'><span className='text-baseColor'>+91 </span>{t('hospital_contact')}</p>
        </div>
      </div>
    </div>
  )
